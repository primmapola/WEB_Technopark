"""
Django settings for webDZ project.
...
SECRET_KEY = 'django-insecure-7!m#(ipli+q_erfz2fm&i329ccad1128=a5nwd^c@x#$je)v*@'
...
WSGI_APPLICATION = 'webDZ.wsgi.application'
